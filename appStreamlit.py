...
def main():
    ...
    para la clasificación de aves a partir de imágenes. Este trabajo fue apoyado en parte por Ministerio de Tecnologías de la Información y las Comunicaciones de Colombia, la Universidad Cooperativa de Colombia, Campus Ibagué - Espinal.
